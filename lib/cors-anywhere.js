...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    // Request filtering
    const filteringResult = corsAnywhere.filterRequests(req);
    if (filteringResult !== true) {
      res.writeHead(filteringResult.status || 400, filteringResult.statusMessage || 'Bad request');
      res.end(filteringResult.message || 'Incorrect request');
      return;
    }
